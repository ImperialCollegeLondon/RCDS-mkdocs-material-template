...
<!-- This is a comment, which will not appear in the rendered Markdown -->
<!-- We'll use comments in this README to suggest improvements to make! -->


<!-- Add some emphasis to the paragraph below. Surround words or phrases with * _ or ` -->

Unfortunately, this `README` ~has~ had very little _Markdown_ in it. Before we get into MkDocs,
...
> [!IMPORTANT]
> After creating your own repository from this template, complete the following steps to get your website online
...
1. **Make a Change**
    ...
    Click on `mkdocs.yml` ➡️ Edit this file ➡️ `site_name:` ➡️ (replace with your website name)
...
<!-- Now, unordered lists. Prefix each line below with - ( you can also use + or * ) -->
...
<!-- To render code blocks, we use 3 backticks ``` , on the line above and the line below.  -->
<!-- Optionally, you can write the language after the opening backticks e.g. ```python  -->
```bash
...
This material was developed by the [RCDS team at ECRI](https://www.imperial.ac.uk/early-career-researcher-institute/learning-and-development/courses-by-programme/research-computing-and-data-science/).

<!-- Images are similar but begin with an exclamation point ![ALT TEXT](URL) -->

![The ECRI logo](docs/assets/ecri-banner.png)
